  ...
  useEffect(() => {
    if (inTeams === true) {
      ...
      if (
        ...
        let lJoinUrl =
          'https://teams.microsoft.com/l/meetup-join/CHAT_ID/0?context={"Tid":"T_ID","Oid":"O_ID"}'
          ...
          <div style={{ position: "relative" }}>
            {inMeeting ? (
              <div className={styles.recordingContainer}>
                <span>
                  <b className={styles.Blink}>&#11044;</b>
                  &nbsp;
                  <b style={{ color: "#ffffff" }}>&nbsp;Recording.</b>
                </span>
              </div>
            ) : null}
